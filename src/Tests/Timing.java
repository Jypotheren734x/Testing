...
public class Timing extends Application{
    ...
    private static final TimingPane timingPane = new TimingPane();
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        timingPane.setExec();
        primaryStage.setScene(new Scene(timingPane));
        primaryStage.show();
    }

    public static void addTests(Test... test){
        timingPane.addTests(test);
    }

    private static class TimingPane extends VBox{
